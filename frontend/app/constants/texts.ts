export const APP_TEXTS = {
  ...
  sidebar: {
    ...
    collectionIcon: '📁',
    deleteIcon: '🗑️',
    addSubcollectionTooltip: "Añadir subcolección",
    renameCollectionTooltip: "Renombrar colección",
    generateBatchAiTooltip: "Generar Batch AI",
    processing: "Procesando",
    batchAiCompleted: "¡Batch AI completado!",
    batchAiCompletedDesc: "Metadatos generados y colección actualizada.",
    batchAiError: "Error al iniciar el proceso.",
    renameError: "No se pudo renombrar la colección.",
    profile: {
    ...
    batchAi: {
      confirmTitle: "Generación masiva de IA",
      confirmMessage: "¿Iniciar procesamiento IA en segundo plano para esta colección?",
      confirmBtn: "Iniciar",
      cancelBtn: "Cancelar",
      successTitle: "Proceso iniciado",
      successMessage: (count: number) => `Procesamiento iniciado: ${count} documentos en cola.`,
